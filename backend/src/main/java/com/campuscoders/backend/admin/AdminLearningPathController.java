...
public class AdminLearningPathController {
  ...
  // Hard-delete path (cascades topics/resources; clears bookmarks and completions first).
  @DeleteMapping("/{learningPathId}")
  @ResponseStatus(HttpStatus.NO_CONTENT)
  public void deleteLearningPathForAdmin(@PathVariable Long learningPathId) {
